...
public class OrderEventMqConfiguration {
    ...
    public Exchange orderEventExchange() {
        ...
        TopicExchange exchange = new TopicExchange(MqConst.EXCHANGE_ORDER_EVNT, true, false);
    ...
    public Binding orderDelayQueueBinding() {
        ...
        return new Binding(MqConst.QUEUE_ORDER_DELAY, Binding.DestinationType.QUEUE, MqConst.EXCHANGE_ORDER_EVNT,
