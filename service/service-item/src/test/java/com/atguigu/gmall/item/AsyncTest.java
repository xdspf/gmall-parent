...
//                });
    ...
    public void test2() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        CompletableFuture.supplyAsync(()->{
            ...
            System.out.println("把"+ t +"保存到数据库中");
        }).whenComplete((t,u)->{
            if ( u != null){
                //记录日志
            }
...
//            System.out.println(Thread.currentThread().getName() + "接到的t:" + t);
//            return t + 3;
//        }, executor);
...
//        },executor);
    ...
    public void test() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
            System.out.println(Thread.currentThread().getName() + ":榆林");
            try {
                Thread.sleep(1000);
        ...
        System.out.println(Thread.currentThread().getName() + ":绥德");

        //void accept(T t, U u);
        future.whenComplete((t,u)->{
            //js  回调
//            if (u!=null){
//                System.out.println("有异常:"+u);
//            }
