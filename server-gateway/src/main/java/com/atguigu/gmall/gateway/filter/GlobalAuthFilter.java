...
import com.atguigu.gmall.gateway.propeties.AuthUrlProperties;
        ...
        for (String url : urlProperties.getLoginAuthUrl()) {
            ...
            if (match) {
                ...
                if (info != null) {
                    ...
                    //redis中无此用户（1.假令牌，2.token没有，未登录）
                    //重定向登录页
...
//        //2、每个元素加2  (先拿到流，把流中的元素遍历一遍)   t：流中的参数   t+2:返回的遍历结果
